...
public class NDateParser {
     ...
     */
    static public synchronized Date parse(String date, boolean _32_bits) throws ParseException {
	Date d = null;
	for (Iterator i = dateFormats.iterator(); i.hasNext(); ) {
	    try {
		d = ((SimpleDateFormat)i.next()).parse(date);
     ...
     */
    static public synchronized Date parse(String date) throws ParseException {
