 ...
 *
 * These morphological rules generate basic variations in word form such as
 * singular, plural, past tense, past and present participles, various
 * forms of irregular verbs (e.g., "break," "broke," "broken"), and they
 * deal with stem ending effects such as silent e's and doubling of final 
 ...
 * <p>
 * The original rules were developed by W. A. Woods and Ellen Hays in 1992,
 * and were modified subsequently by W. A. Woods.
 *
 * @author Roger D. Brinkley
 * @author W. A. Woods
 * @author Jacek Ambroziak
 * @version	1.2	12/05/2001
 * 
 * @see LiteMorph
 */
public class LiteMorph_en extends LiteMorph{
	...
	if (morph == null) {
	    morph = new LiteMorph_en();
	}
        else localizedMorph = morph;
	return morph;
    }
	...
	if (exceptions != null) {
        ...
        localizedMorph = this;
	rulesTable = new Hashtable(200, (float)0.7);
	...
	String[] exceptionTable = {
	    ...
	    //opt//"glum glummer glummest glumly glumness",
	...
	String[] sRules = {
 ".aeiouy |bcdfghjklmnpqrstvwxyz + i n e s s -> y,ies,ier,iers,iest,ied,ying,yings,ily,inesses,iment,iments,iless,iful",
	    // 	(e.g., happiness, business)

 ".aeiouy + e l e s s -> e,es,er,ers,est,ed,ing,ings,eing,eings,ely,eness,enesses,ement,ements,"
	      +"eness,enesses,eful",
	    // 	(e.g., baseless, shoeless)

 "|bcdfghjklmnpqrstvwxyz |aeiouy |bdgklmnprt + l e s s -> _,s,&er,&ers,&est,&ed,&ing,&ings,ly,ness,nesses,ment,ments,ful",
	    // 	(e.g., gutless, hatless, spotless)

 ".aeiouy + l e s s -> _,s,er,ers,est,ed,ing,ings,ly,ness,nesses,ment,ments,ful",
	    // 	(e.g., thoughtless, worthless)

 ".aeiouy + e n e s s -> e,es,er,ers,est,ed,ing,ings,eing,eings,ely,enesses,ement,ements,"
	      +"eless,eful",
	    // 	(e.g., baseness, toeness)

 ".aeiouy + n e s s -> _,s,er,ers,est,ed,ing,ings,ly,nesses,ment,ments,less,ful",
	    // 	(e.g., bluntness, grayness)

 ".aeiouy s s + -> es,er,ers,est,ed,ing,ings,ly,ness,nesses,ment,ments,less,ful",
	    // 	(e.g., albatross, kiss)

 ".aeiouy o u s + -> ly,ness",
	    // 	(e.g., joyous, fractious, gaseous)

 "+ i e s -> y,ie,yer,yers,ier,iers,iest,ied,ying,yings,yness,iness,ieness,ynesses,"
	      +"inesses,ienesses,iment,iement,iments,iements,yless,iless,ieless,yful,"
	      +"iful,ieful",
	    // 	(e.g., tries, unties, jollies, beauties)

 ".aeiouy + s i s -> ses,sises,sisness,sisment,sisments,sisless,sisful",
	    // 	(e.g., crisis, kinesis)

 ".aeiouy i s + -> es,ness,ment,ments,less,ful",
	    // 	(e.g., bronchitis, bursitis)

 ".aeiouy c h + e s -> _,e,er,ers,est,ed,ing,ings,ly,ely,ness,eness,nesses,enesses,ment,"
	      +"ement,ments,ements,less,eless,ful,eful",

 ".aeiouy s h + e s -> _,e,er,ers,est,ed,ing,ings,ly,ely,ness,eness,nesses,enesses,ment,"
	      +"ement,ments,ements,less,eless,ful,eful",

 ".aeiouy |bcdfghjklmnpqrstvwxz + i z e s -> ize,izer,izers,ized,izing,izings,ization,izations,"
	      +"ise,ises,iser,isers,ised,ising,isings,isation,isations",
	    // 	(e.g., tokenizes) // adds British variations

 ".aeiouy |bcdfghjklmnpqrstvwxz + i s e s -> ize,izes,izer,izers,ized,izing,izings,ization,izations,"
	      +"ise,iser,isers,ised,ising,isings,isation,isations",
	    // 	(e.g., tokenises) // British variant  // ~expertise

 ".aeiouy |jsxz + e s -> _,e,er,ers,est,ed,ing,ings,ly,ely,ness,eness,nesses,enesses,ment,"
	      +"ement,ments,ements,less,eless,ful,eful",
	    // 	(e.g., aches, arches)
	    //  v is not in this set because ve words can keep the e before ing
	    //  NB: we are not handling -is plurals like crises

 ".aeiouy d g + e s -> e,er,ers,est,ed,ing,ings,ely,eness,enesses,ment,ments,ement,ements,"
	      +"eless,eful",
	    // 	(e.g., judges, abridges)
 ...
 ".aeiouy d g + m e n t s -> ment,*ment",
	    // 	(e.g., judgments, abridgments)

 ".aeiouy |bcdfghjklmnpqrstvwxyz i m e n t + s -> _,*_",
	    // 	(e.g., merriments, embodiments)
	    //  -iment in turn will generate y and *y (redo y)

 ".aeiouy m e n t + s -> _,*_",
	    // 	(e.g., atonements, entrapments)

 ".aeiouy e r + s -> _,*_",
	    // 	(e.g., viewers, meters, traders, transfers)

 ".aeiouy |bcdfghjklmnpqrstvwxyz |aeiouy |bdglmnprt + s -> _,*_",
	    // 	(e.g., unflags)
	    //  polysyllables

 "|bcdfghjklmnpqrstvwxyz |aeiouy |bdglmnprt + s -> _,*_",
	    // 	(e.g., frogs)
	    //  monosyllables
 ...
 "a + s -> "
      +"_,er,ers,est,ed,ing,ings,ly,ness,nesses,ment,ments,less,ful",
	    // 	(e.g., boas, polkas, spas)
            // don't generate latin endings

 ".aeiouy .bcdfghjklmnpqrstvwxyz + s -> "
      +"_,*_",
	    // 	(e.g., beads, toads)

 ".bcdfghjklmnpqrstvwxyz |aeiouy + s -> "
      +"_,er,ers,est,ed,ing,ings,ly,ness,nesses,ment,ments,less,ful",
	    // 	(e.g., boas, zoos)
 ...
 "s s + -> "
      +"_",
	    // 	(e.g., ss, sss, ssss)
            // no vowel (vowel case is already handled above)

 ".bcdfghjklmnpqrstvwxyz |bcdfghjklmnpqrstvwxyz12345567890 + s -> "
      +"_",
	    // 	(e.g., cds, lcds, m-16s)
	...
	String[] eRules = {
 "a p p l + e -> es,er,ers,est,ed,ing,ings,ely,eness,enesses,ement,ements,eless,eful",
	    // 	(e.g., apple, so it doesn't include apply)

 "s u p p l + e -> es,er,ers,est,ed,ing,ings,ely,eness,enesses,ement,ements,eless,eful",
	    // 	(e.g., supple, so it doesn't include supply)

 ".aeiouy |bcdfghjklmnpqrstvwxyz l + e -> es,er,ers,est,ed,ing,ings,y,ely,eness,enesses,ement,ements,eless,eful",
	    // 	(e.g., able, abominable, fungible, table, enable, idle, subtle)

 "+ i e -> ies,ier,iers,iest,ied,ying,yings,iely,ieness,ienesses,iement,iements,"
	      +"ieless,ieful",
	    // 	(e.g., bookie, magpie, vie)

 "y e + -> s,r,rs,st,d,ing,ings,ly,ness,nesses,ment,ments,less,ful",
	    // 	(e.g., dye, redye, redeye)

 ".aeiouy d g + e -> es,er,ers,est,ed,ing,ings,ely,eness,enesses,ment,ments,less,ful,ement,"
	      +"ements,eless,eful",
	    // 	(e.g., judge, abridge)

 "u + e -> es,er,ers,est,ed,ing,ings,eing,eings,ly,ely,eness,enesses,ment,ments,"
	      +"less,ful,ement,ements,eless,eful",
	    // 	(e.g., true, due, imbue)

 ".aeiouy |bcdfghjklmnpqrstvwxz + i z e -> izes,izer,izers,ized,izing,izings,ization,izations,"
	      +"ise,ises,iser,isers,ised,ising,isings,isation,isations",
	    // 	(e.g., tokenize) // adds British variations

 ".aeiouy |bcdfghjklmnpqrstvwxz + i s e -> ize,izes,izer,izers,ized,izing,izings,ization,izations,"
	      +"ises,iser,isers,ised,ising,isings,isation,isations",
	    // 	(e.g., tokenise) // British variant  // ~expertise

 ".aeiouy + e -> es,er,ers,est,ed,ing,ings,eing,eings,ely,eness,enesses,ement,ements,"
	      +"eless,eful",
	...
	String[] edRules = {
 "r e e + d -> ds,der,ders,ded,ding,dings,dly,dness,dnesses,dment,dments,dless,dful,_,*_",
	    // 	(e.g., agreed, freed, decreed, treed)

 "e e + d -> ds,der,ders,ded,ding,dings,dly,dness,dnesses,dment,dments,dless,dful",
	    // 	(e.g., feed, seed, Xweed)

 "|bcdfghjklmnpqrstvwxyz + i e d -> y,ie,ies,ier,iers,iest,ying,yings,ily,yly,iness,yness,inesses,ynesses,"
	      +"iment,iments,iless,iful,yment,yments,yless,yful",
	    // 	(e.g., tried)

 ".aeiouy .bcdfghjklmnpqrstvwxyz l + l e d -> _,s,er,ers,est,ing,ings,ly,ness,nesses,ment,ments,less,ful,&,&s,"
	      +"&er,&ers,&est,&ing,&ings,&y,&ness,&nesses,&ment,&ments,&ful",
	    // 	(e.g., controlled, fulfilled, rebelled)
	    //  both double and single l forms

 ".aeiouy l + l e d -> &,&s,&er,&ers,&est,&ing,&ings,&y,&ness,&nesses,&ment,&ments,&ful",
	    // 	(e.g., pulled, filled, fulled)

 ".aeiouy s + s e d -> &,&es,&er,&ers,&est,&ing,&ings,&ly,&ness,&nesses,&ment,&ments,&less,&ful",
	    // 	(e.g., hissed, grossed)

 "|bcdfghjklmnpqrstvwxyz |aeiouy |bdgklmnprt + & e d -> _,s,&er,&ers,&est,&ing,&ings,ly,ness,nesses,ment,ments,less,ful",
	    // 	(e.g., hugged, trekked)

 ".aeiouy |bcdfghjklmnpqrstvwxz + i z e d -> izes,izer,izers,ize,izing,izings,ization,izations,"
	      +"ise,ises,iser,isers,ised,ising,isings,isation,isations",
	    // 	(e.g., tokenize) // adds British variations

 ".aeiouy |bcdfghjklmnpqrstvwxz + i s e d -> ize,izes,izer,izers,ized,izing,izings,ization,izations,"
	      +"ises,iser,isers,ise,ising,isings,isation,isations",
	    // 	(e.g., tokenise) // British variant  // ~expertise

 ".aeiouy + e d -> _,e,s,es,er,ers,est,ing,ings,ly,ely,ness,eness,nesses,enesses,"
	      +"ment,ement,ments,ements,less,eless,ful,eful",
	    // 	(e.g., spoiled, tooled, tracked, roasted, atoned, abridged)

 "e d + -> s,&er,&ers,&est,&ed,&ing,&ings,ly,ness,nesses,ment,ments,less,ful",
	    // 	(e.g., bed, sled)
	...
	String[] erRules = {
 "m e t e r + -> s,er,ers,ed,ing,ings,ly,ness,nesses,ment,ments,less,ful",
	    // 	(e.g., altimeter, ammeter, odometer, perimeter)

 "+ e e r -> eers,eered,eering,eerings,eerly,eerness,eernesses,eerment,eerments,"
 ...
 ".aeiouy |bcdfghjklmnpqrstvwxyz + i e r -> y,ie,ies,iest,ied,ying,yings,ily,yly,iness,yness,inesses,ynesses,"
 ...
 ".aeiouy l + l e r -> &,&s,&est,&ed,&ing,&ings,ly,lely,&ness,&nesses,&ment,&ments,&ful,"
 ...
 ".aeiouy s + s e r -> &,&es,&est,&ed,&ing,&ings,&ly,&ness,&nesses,&ment,&ments,&less,&ful,"
 ...
 "|bcdfghjklmnpqrstvwxyz |aeiouy |bdgkmnprt + & e r -> _,s,&est,&ed,&ing,&ings,ly,ness,nesses,ment,ments,less,ful,&ers,&ered,"
	      +"&ering,&erings,&erly,&erness,&ernesses,&erments,&erless,&erful",
	    // 	(e.g., bigger, trekker, hitter)
	    //  did not add: &erer, &erest, &errer, &errers, &errest,
	    //  since i think the &er here is always an ending (?)

 ".aeiouy |bcdfghjklmnpqrstvwxz + i z e r -> izes,ize,izers,ized,izing,izings,ization,izations,"
	      +"ise,ises,iser,isers,ised,ising,isings,isation,isations",
	    // 	(e.g., tokenize) // adds British variations

 ".aeiouy |bcdfghjklmnpqrstvwxz + i s e r -> ize,izes,izer,izers,ized,izing,izings,ization,izations,"
	      +"ises,ise,isers,ised,ising,isings,isation,isations",
	    // 	(e.g., tokenise) // British variant  // ~expertise

 ".aeiouy + e r -> _,e,s,es,est,ed,ing,ings,ly,ely,ness,eness,nesses,enesses,ment,ments,"
	...
	String[] estRules = {
 "|bcdfghjklmnpqrstvwxyz + i e s t -> y,ies,ier,iers,ied,ying,yings,ily,yly,iness,yness,inesses,ynesses,"
	      +"iment,iments,iless,iful",
	    // 	(e.g., sliest, happiest, wittiest)

 ".aeiouy l + l e s t -> &,&s,&er,&ers,&ed,&ing,&ings,ly,&ness,&nesses,&ment,&ments,&ful",
	    // 	(e.g., fullest)

 ".aeiouy s + s e s t -> &,&es,&er,&ers,&ed,&ing,&ings,&ly,&ness,&nesses,&ment,&ments,&less,&ful",
	    // 	(e.g.,  grossest)

 "|bcdfghjklmnpqrstvwxyz |aeiouy |bdglmnprst + & e s t -> _,s,&er,&ers,&ed,&ing,&ings,ly,ness,nesses,ment,ments,less,ful",
	    // 	(e.g., biggest)

 ".aeiouy c h + e s t -> e,es,er,ers,ed,ing,ings,ly,ely,ness,eness,nesses,enesses,ment,ments,"
 ...
 ".aeiouy s h + e s t -> e,es,er,ers,ed,ing,ings,ly,ely,ness,eness,nesses,enesses,ment,ments,"
	      +"less,ful,ement,ements,eless,eful,ests,ester,esters,ested,"
	      +"esting,estings,estly,estness,estnesses,estment,estments,estless,estful",

 ".aeiouy |jsxz + e s t -> e,es,er,ers,ed,ing,ings,ly,ely,ness,eness,nesses,enesses,ment,ments,"
	      +"less,ful,ement,ements,eless,eful,ests,ester,esters,ested,"
	      +"esting,estings,estly,estness,estnesses,estment,estments,estless,estful",
	    // 	(e.g., basest, archest, rashest)

 "e r + e s t -> e,es,er,ers,ed,eing,eings,ely,eness,enesses,ement,ements,eless,eful,"
 ...
 ".aeiouy + e s t -> _,e,s,es,er,ers,ed,ing,ings,ly,ely,ness,eness,nesses,enesses,ment,ments,"
 ...
 "e s t + -> s,er,ers,ed,ing,ings,ly,ness,nesses,ment,ments,less,ful",
	    // 	(e.g., rest, test)
	    //  monosyllables
	};
	...
	String[] fulRules = {
 ".aeiouy |bcdfghjklmnpqrstvwxyz + i f u l -> ifully,ifulness,*y",
	    // 	(e.g., beautiful, plentiful)

 ".aeiouy + f u l -> fully,fulness,_,*_",
 ...
 ".aeiouy + i c -> ics,ical,ically",
	...
	String[] ingRules = {
 "|bcdfghjklmnpqrstvwxyz + y i n g -> yings,ie,y,ies,ier,iers,iest,ied,iely,yly,ieness,yness,ienesses,ynesses,"
	      +"iment,iments,iless,iful",
	    // 	(e.g., dying, crying, supplying)
	    //  did not add -ing forms (see last 8 ing-rules)

 ".aeiouy l + l i n g -> _,*_,&,&s,&er,&ers,&est,&ed,&ings,&ness,&nesses,&ment,&ments,&ful",
 ...
 ".aeiouy s + s i n g -> &,&s,&er,&ers,&est,&ed,&ings,&ly,&ness,&nesses,&ment,&ments,&less,&ful",
	    // 	(e.g., hissing, grossing, processing)
	    //  did not add -ing forms (see last 8 ing-rules)

 "|bcdfghjklmnpqrstvwxyz |aeiouy |bdgklmnprt + & i n g -> _,s,&er,&ers,&est,&ed,&ings,ly,ness,nesses,ment,ments,less,ful",
	    // 	(e.g., hugging, trekking)
	    //  did not add -ing forms (see last 8 ing-rules)

 "+ e e i n g -> ee,ees,eer,eers,eest,eed,eeings,eely,eeness,eenesses,eement,eements,"
	      +"eeless,eeful",
	    // 	(e.g., freeing, agreeing)
	    //  did not add -ing forms (see last 8 ing-rules)

 ".aeiouy + e i n g -> e,es,er,ers,est,ed,eings,ely,eness,enesses,ement,ements,eless,eful",
	    // 	(e.g., ageing, aweing)
	    //  did not add -ing forms (see last 8 ing-rules)

 "|aeiou y + i n g -> _,s,er,ers,est,ed,ings,ly,ingly,ness,nesses,ment,ments,less,ful",
	    // 	(e.g., toying, playing)
	    //  did not add -ing forms (see last 8 ing-rules)

 ".aeiou |bcdfghjklmnpqrstvwxyz |eio t + i n g -> _,*_,*e,ings,inger,ingers,ingest,inged,inging,ingings,ingly,"
 ...
 "|bcdfghjklmnpqrstvwxyz |aeiouy |bdgklmt + i n g -> *e,ings,inger,ingers,ingest,inged,inging,ingings,ingly,"
	      +"ingness,ingnesses,ingment,ingments,ingless,ingful",
 ...
 ".aeiouy |bcdfghjklmnpqrstvwxz + i z i n g -> izes,izer,izers,ized,ize,izings,ization,izations,"
	      +"ise,ises,iser,isers,ised,ising,isings,isation,isations",
	    // 	(e.g., tokenize) // adds British variations

 ".aeiouy |bcdfghjklmnpqrstvwxz + i s i n g -> ize,izes,izer,izers,ized,izing,izings,ization,izations,"
	      +"ises,iser,isers,ised,ise,isings,isation,isations",
	    // 	(e.g., tokenise) // British variant  // ~expertise

 "|aeiouy |cgsvz + i n g -> *e,ings,inger,ingers,ingest,inged,inging,ingings,ingly,"
	      +"ingness,ingnesses,ingment,ingments,ingless,ingful",
 ...
 "|bcdfghjklmnpqrstvwxyz |clsuv + i n g -> *e,ings,inger,ingers,ingest,inged,inging,ingings,ingly,"
	      +"ingness,ingnesses,ingment,ingments,ingless,ingful",
	    // 	(e.g., dancing, troubling, arguing, bluing, carving)

 ".aeiouy |lr g + i n g -> *e,ings,inger,ingers,ingest,inged,inging,ingings,ingly,"
	      +"ingness,ingnesses,ingment,ingments,ingless,ingful",
	    // 	(e.g., charging, bulging)

 ".aeiouy |bcdfghjklmnpqrstvwxyz |bdfjkmnpqrtwxz + i n g -> _,*_,ings,inger,ingers,ingest,inged,inging,ingings,ingly,"
	      +"ingness,ingnesses,ingment,ingments,ingless,ingful",
	    // 	(e.g., farming, harping, interesting, bedspring, redwing)

 ".aeiouy + i n g -> _,*_,*e,ings,inger,ingers,ingest,inged,inging,ingings,ingly,"
	      +"ingness,ingnesses,ingment,ingments,ingless,ingful",
 ...
 "+ i n g -> ings,inger,ingers,ingest,inged,inging,ingings,ingly,"
	      +"ingness,ingnesses,ingment,ingments,ingless,ingful",
	    // 	(e.g., wing, thing)
	    //  monosyllables
	};
 ...
 "+ l e a f -> leaves",
	...
	String[] manRules = {
 "+ m a n -> men,mans,maner,manner,manners,maners,manest,maned,manned,maning,"
	...
	String[] menRules = {
 "+ m e n -> man,mens,mener,meners,menest,mened,mening,menings,menly,"
 ...
 ".aeiouy + m e n t -> _,*_",
	...
	String[] oRules = {
 "|aeiou o + -> s,er,ers,est,ed,ing,ings,ly,ness,nesses,ment,ments,less,ful",
	    // 	(e.g., taboo, rodeo)
	    //  no need to generate an es form

 ".aeiouy o + -> s,es,er,ers,est,ed,ing,ings,ly,ness,nesses,ment,ments,less,ful",
	    // 	(e.g., tomato, bonito)
	...
	String[] umRules = {
 ".aeiouy + u m -> a,ums,umer,ummer,umers,ummers,umed,ummed,uming,umming,umings,"
	...
	String[] yRules = {
 ".aeiouy b + l y -> le,les,ler,lers,lest,led,ling,lings,leness,lenesses,lement,lements,"
	      +"leless,leful",
	    // 	(e.g., ably, horribly, wobbly)

 ".aeiouy |bcdfghjklmnpqrstvwxyz + i l y -> y,ies,ier,iers,iest,ied,ying,yings,yness,iness,ynesses,inesses,"
	      +"iment,iments,iless,iful",
	    // 	(e.g., happily, dizzily)

 ".aeiouy f u l + l y -> _,*_",
	    // 	(e.g., peaceful+ly)

 ".aeiouy l + l y -> _,*_,lies,lier,liers,liest,lied,lying,lyings,liness,linesses,"
	      +"liment,liments,liless,liful,*l",
	    // 	(e.g., fully, folly, coolly, fatally, dally)
	    //  both -l and -ll words

 "|aou + l y -> lies,lier,liers,liest,lied,lying,lyings,liness,linesses,"
	      +"liment,liments,liless,liful",
	    // 	(e.g., monopoly, Xcephaly, holy)
	    //  i.e., treat ly as part of the stem

 ".aeiouy + l y -> _,*_,lies,lier,liers,liest,lied,lying,lyings,liness,linesses,lyless,lyful",
	    // 	(e.g., frequently, comely, deeply, apply, badly)
	    //  i.e., redo stem AND generate all forms with ly as part of stem

 "|bcdfghjklmnpqrstvwxyz + y -> ies,ier,iers,iest,ied,ying,yings,ily,yness,iness,ynesses,inesses,"
	      +"iment,iments,iless,iful,yment,yments,yless,yful",
	    // 	(e.g., happy, ply, spy, cry)

 "|aeiou y + -> s,er,ers,est,ed,ing,ings,ly,ness,nesses,ment,ments,less,ful",
	    // 	(e.g., betray, gay, stay)
	};
	...
	String[] rootRules = {
 ".aeiouy c h + -> es,er,ers,est,ed,ing,ings,ly,ness,nesses,ment,ments,less,ful",

 ".aeiouy s h + -> es,er,ers,est,ed,ing,ings,ly,ness,nesses,ment,ments,less,ful",

 ".aeiouy |jxz + -> es,er,ers,est,ed,ing,ings,ly,ness,nesses,ment,ments,less,ful",
	    // 	(e.g., fix, arch, rash)

 ".aeiouy |bcdfghjklmnpqrstvwxyz |aeiouy |bdglmnprt + -> s,er,ers,est,ed,ing,ings,&er,&ers,&est,&ed,&ing,&ings,ly,"
	      +"ness,nesses,ment,ments,less,ful",
	    // 	(e.g., unflag, open, besot)
	    //  both possibilities for multisyllables

 "|bcdfghjklmnpqrstvwxyz |aeiouy |bdglmnprt + -> s,&er,&ers,&est,&ed,&ing,&ings,ly,ness,nesses,ment,ments,less,ful",
	    // 	(e.g., bed, cop)

 ".aeiouy |bcdfghjklmnpqrstvwxyz |aeiouy m a + t a -> _,s,tas,tum,tums,ton,tons,tic,tical",
	    // 	(e.g., schemata, automata)

 ".aeiouy t + a -> as,ae,um,ums,on,ons,ic,ical",
	    // 	(e.g., chordata, data, errata, sonata, toccata)

 ".aeiouy .bcdfghjklmnpqrstvwxyz + a -> as,aed,aing,ae,ata,um,ums,on,ons,al,atic,atical",
	    // 	(e.g., polka, spa, schema, ova, polyhedra)

 ".aeiouy l l + -> s,er,ers,est,ed,ing,ings,y,ness,nesses,ment,ments,-less,ful",
	    // 	(e.g., full)
	    //  note: adds a hyphen before less

 ".aeiouy + -> s,er,ers,est,ed,ing,ings,ly,ness,nesses,ment,ments,less,ful",
	    // 	(e.g., spoon, rhythm)
	};
	...
	defRules("ed", edRules);
	defRules("er", erRules);
	defRules("est", estRules);
	defRules("ful", fulRules);
	defRules("ic", icRules);
	defRules("ical", icalRules);
	defRules("ing", ingRules);
	defRules("man", manRules);
	defRules("men", menRules);
	defRules("ment", mentRules);
	defRules("leaf", leafRules);
	defRules("o", oRules);
	defRules("um", umRules);
	defRules("y", yRules);
    ...
    private static void debug(String str) {
        if( localizedMorph.debugFlag ) {
            System.out.println("LiteMorph_en: " + str);
        }
    }
