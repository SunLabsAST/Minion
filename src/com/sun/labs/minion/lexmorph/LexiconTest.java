...
public class LexiconTest {
    ...
    public static void main(String[] args) {
        ...
        //
        // Set up the log.
        Logger logger = Logger.getLogger(LexiconTest.class.getName());
                ...
                if(input == null || input.equals("")) {
                    ...
                    if(input.startsWith("assign")) {
                        ...
                        if(testlex.highCatIndex < 3) {
                            System.out.println(
                                    "Need to assign index nums first...");
                        } else {
                        ...
                        if(w1 != null) {
                            System.out.println(w1.printString() +
                                    ".inflectionRoots(" +
                                    c1Str + ") = " +
                                    LexiconUtil.arrayToString(w1.
                                    getInflectionRoots(c1)));
                        } else {
                            System.out.println(
                                    "need a word to get its inflectionRoots");
                        }
                        ...
                        if(tokens.hasMoreTokens() &&
                                ...
                                (boolString.startsWith("t") || boolString.
                                startsWith("T"))) {
                            nonames = true;
                        }
                        if(w1 != null) {
                            System.out.println(w1.printString() +
                                    ".nonRootParents(" +
                                    nonames + ") = " +
                                    LexiconUtil.arrayToString(w1.nonRootParents(
                                    nonames)));
                        } else {
                            System.out.println(
                                    "need a word to get its nonRootParents");
                        }
                        ...
                        System.out.println("opening bin lex file " + argument +
                                ".blex");
                        ...
                        if(w1 != null) {
                            System.out.println(w1.printString() +
                                    ".directRoots() = " +
                                    LexiconUtil.arrayToString(
                                    w1.getDirectRoots()));
                        } else {
                            System.out.println(
                                    "need a word to get its directRoots");
                        }
                        ...
                        System.out.println("dumping bin lex Index for " +
                                argument);
                        icount = testlex.dumpLexIndex(argument);
                        if(icount > 0) {
                            System.out.println("Wrote index of " + icount +
                                    " objects");
                        ...
                        System.out.println(
                                "searching loaded lexicon for iko/iio equivs");
                        HashMap eh = testlex.findEquivs();
                        TreeMap fe = new TreeMap(eh);

                        System.out.println("found " + fe.size() +
                                " equivocations");
                        ...
                        System.out.println(
                                "Reloading any deffered lexical items ");
                        ...
                        System.out.println(
                                "Marking parents of preserved words for preservation");
                        ...
                        blHistory += ":preserved preserved " + icount +
                                " words\n";
                        ...
                        System.out.println(
                                "assigning any needed new index numbers");
                        ...
                        System.out.println(
                                "Searching loaded lexicon for stub words");
                        ...
                        if(testword != null) {
                            ...
                            System.out.println(dtags + (Lexicon.WORDINDEXMASK &
                                    testword.index));
                        } else {
                        ...
                        if(testword != null) {
                            ...
                            if(testword.sensenamep()) {
                                System.out.println("  sensecat=" + testword.
                                        getSenseCat() +
                                        "; senseword=" + testword.getSenseWord() +
                                        "; senseTail=" + testword.
                                        getSenseTailString());
                            } else {
                                System.out.println(" no sensename entry ");
                            }
                        } else {
                            System.out.println(argument + " not found.");
                        }
                        ...
                        if(testlex.highCatIndex < 3) {
                            ...
                            System.out.println(
                                    "Can't reload until DiskLex is opened");
                            ...
                            if(w == null) {
                                System.out.println("can't find a word =>" +
                                        argument + "<=");
                            } else {
                        ...
                        if(temp != null) {
                            ...
                            System.out.println(argument + " not in lexicon");
                        }
                    } else if(input.startsWith("restore ")) {
                        argument = input.substring(8);
                        System.out.println("restoring bin lex Index for " +
                                argument +
                                ".bidx");
                        ...
                        if(icount > 0) {
                            System.out.println("restored index of " + icount +
                                    " objects");
                            blHistory += ":restored index " + argument +
                                    ".bidx\n";
                        } else {
                            System.out.println("restoring index failed");
                            blHistory += ":restore " + argument +
                                    ".bidx failed\n";
                        }
                        ...
                        blHistory += ":restored full bin lex " + argument +
                                ".blex\n";
                        ...
                        System.out.println("reloaded " + icount +
                                " core word entries");
                        ...
                        argument = input.substring(10).trim();
                        System.out.println("Saving morphed words to: " +
                                argument);
                        ...
                        argument = input.substring(5);
                        System.out.println("Setting lexicon size to: " +
                                argument);
                        try {
                        ...
                        if(testwt == null) {
                            ...
                            System.out.println("roots = " + LexiconUtil.
                                    arrayToString(wtroots) +
                                    "; nrParents = " +
                                    LexiconUtil.arrayToString(wtparents));
                        }
