...
public interface SearchEngine extends Searcher {
    ...
    /**
     * Creates a multi-fielded document vector for the given document as though
    ...
    /**
     * Creates a document vector for the given Indexable document as though it
     * occurred in the index.
     *
     * @param doc an Indexable for which we want a document vector. The document
     * will be processed as though it were being indexed in order to extract the
     * appropriate document vector, but the data resulting from processing
     * <em>will not</em> be added to the index.
     * @param fields the fields for which we want a document vector
     * @return the document vector for the indexable document, which will be 
     * generated by combining the vectors from each of the fields.
     * @throws SearchEngineException
     */
    public DocumentVector getDocumentVector(Indexable doc, String[] fields)
            throws SearchEngineException;
