...
public abstract class Partition implements Comparable<Partition>, Configurable {
    ...
    public int getNumPostingsChannels() {
        try {
            return ((Entry) mainDictFactory.getEntryClass().newInstance()).
                    getNumChannels();
        } catch(Exception e) {
    ...
    com.sun.labs.minion.indexer.dictionary.DictionaryFactory.class)
    ...
    public void newProperties(PropertySheet ps) throws PropertyException {
        ...
        mainDictFactory = (DictionaryFactory) ps.getComponent(
                PROP_MAIN_DICT_FACTORY);
        docDictFactory = (DictionaryFactory) ps.getComponent(
