...
public class IDFreqEntry extends SinglePostingsEntry implements MergeableEntry {

    public IDFreqEntry() {
        super(null);
    }
    
    public IDFreqEntry(Object name) {
        super(name);
    }
    
    public Entry getEntry(Object name) {
        return new IDFreqEntry(name);
    }
    ...
    protected Postings getPostings(ReadableBuffer input) {
        return new IDFreqPostings(input);
    }
    ...
    public void merge(QueryEntry qe, int[] idMap) {
        ...
        ((MergeablePostings) p).merge(((MergeablePostings) ((IDFreqEntry) qe).p), idMap);
    }
