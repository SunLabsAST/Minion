...
import java.util.ListResourceBundle;
   ...
   * the entry "<and>, and" should be translated to "<und>, and"
...
public class ReaderResources_de extends ListResourceBundle {
  ...
  static final Object[][] contents = {
     ...
     */
    {"liteMorph", com.sun.labs.minion.lexmorph.LiteMorph_de.getMorph()},
     ...
     * for German, the entry "<and>, and" should be translated to
     * "<und>, and" (the second of the pair is unchanged).  The second
