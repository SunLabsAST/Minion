...
public class URLIndexTest extends SEMain {
    ...
    public static void reportProgress(long start,
        ...
        Logger.getLogger(URLIndexTest.class.getName()).info(
                n + " documents, " +
                form.format(secs) + " s, " +
    ...
    public static void main(String[] args) throws MalformedURLException {
        ...
        // verbose.
        Logger logger = Logger.getLogger(URLIndexTest.class.getName());
        ...
        if(urlsFile == null) {
            logger.warning("You must specify a file of URLS to index with " +
            ...
            try {
                while((n = r.readLine()) != null) {
                    ...
                    try {
                        ...
                        logger.warning("Skipping bad URL: " + n);
                        continue;
                    }
                    ...
                    try {
                        ...
                        logger.log(Level.SEVERE, "Error indexing url " + toIndex,
                                se);
                    } catch(Exception e) {
        ...
        try {
            ...
            logger.log(Level.SEVERE, "Error closing engine",
                    se);
        }
