...
/**
 * An ElementHandler to handle <i>Optimizing</i> XML Elements
 * @author Bernard Horan
 *
 */
class OptimizingElementHandler extends ElementHandler {

    /**
     * Constructor to set the name of the element handler to "Optimizing"
     * @see com.sun.labs.minion.test.regression.merge.ElementHandler#ElementHandler(MergeTestReplayer)
     */
    public OptimizingElementHandler(MergeTestReplayer replayer) {
        super(replayer);
        name = "Optimizing";
    }
    /**
     * Causes the replayer to optimise the index
