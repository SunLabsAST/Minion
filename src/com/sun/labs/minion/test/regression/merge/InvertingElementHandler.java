...
/**
 * An ElementHandler to handle <i>Inverting</i> XML Elements
 * @author Bernard Horan
 *
 */
class InvertingElementHandler extends ElementHandler {

    /**
     * Constructor to set the name of the element handler to "Inverting"
     * @see com.sun.labs.minion.test.regression.merge.ElementHandler#ElementHandler(MergeTestReplayer)
     */
    public InvertingElementHandler(MergeTestReplayer replayer) {
        super(replayer);
        name = "Inverting";
    }
    /**
     * Caused the replayer to invert the index
