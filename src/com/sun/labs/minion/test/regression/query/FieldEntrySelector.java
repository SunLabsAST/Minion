...
interface FieldEntrySelector {

    /**
     * Returns the first and last entry of the first and last field
     * of the field store of each partition.
     *
     * @param manager the PartitionManager which contains the index
     *
     * @return a list of selected entries
     */
    List<FieldEntry> selectEntries(PartitionManager manager);
