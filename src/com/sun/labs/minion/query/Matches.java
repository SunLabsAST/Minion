 ...
 */
public class Matches extends StringRelation implements Serializable {
    /**
     * Creates a string matching relation.
     * @param field the field whose values we want to test
     * @param value the value to test against
     */
    public Matches(String field, String value) {
        super(field, Operator.MATCHES, value);
    }
